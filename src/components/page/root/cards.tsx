                  ...
                  each={[
                    {
                      ...
                      imagePath: "/Images/cardImage/konsepDasar.png",
                    },
                    {
                    ...
                    {
                      cardTitle: "Latihan Limit Fungsi",
                      align: "start",
                      cardDescription:
                        "Sudah menguasai semua materinya? Ayo coba latihannya !",
                      level: level.levelFinish.exercise,
                      endPoint: "/latihan",
                      imagePath: "/Images/cardImage/exercise.png",
                    },
                  ]}
                >
                  {(item, index) => (
